        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500 font-medium">
              Explore public works contracts across the 13 Barangays of Trece
              Martires City.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="relative group">
              ...
              >
                {DPWH_CATEGORIES.map(cat => (
                  <option key={cat} value={cat} className="text-slate-900 py-1">
            ...
            <div className="relative group">
              ...
              >
                {DPWH_STATUSES.map(st => (
                  <option key={st} value={st} className="text-slate-900 py-1">
          ...
          <div className="md:col-span-4 lg:col-span-2">
            ...
            <div className="relative group">
              ...
              >
                {DPWH_YEARS.map(yr => (
                  <option key={yr} value={yr} className="text-slate-900 py-1">
                    {yr} ({yearCounts[yr] || 0})
                  </option>
                ))}
              </select>
            ...
            >
              <thead className="bg-slate-50 text-slate-800 font-extrabold uppercase text-[11px] tracking-wider border-b border-slate-200">
                <tr>
                  ...
                  <th scope="col" className="w-[34%] py-4 px-4 font-extrabold">
