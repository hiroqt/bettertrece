...
| Indicator                  | Official Metric                           | Data Source                                   |
| :------------------------- | :---------------------------------------- | :-------------------------------------------- |
...
## 13 Constituent Barangays & PSGC Directory
...
## National Classification & Open Data Reference

Local government datasets and statistics are aligned with the official classification systems established by the Philippine Statistics Authority.

- **Interactive Classification Explorer**: Browse all 9 PSA systems at [/demographics#psa-classifications](/demographics#psa-classifications).
- **Official PSA Classification Portal**: [classification.psa.gov.ph](https://classification.psa.gov.ph)
- **PSA Swagger API Reference**: [classification.psa.gov.ph/api/documentation](https://classification.psa.gov.ph/api/documentation)
- **Request Official PSA Token**: [PSA Classifications API Access Form](https://psa.gov.ph/classifications-api/request-access-form)
